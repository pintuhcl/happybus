 ...
 */
@Service
public class IdentityCard2ItemProcessor implements ItemProcessor<IdentityCard2, IdentityCard2> {
	private Logger logger = Logger.getLogger(IdentityCard2ItemProcessor.class);
