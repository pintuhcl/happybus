...
public class Patient {
	...
	@JoinTable(name = "doctors_patients", joinColumns = @JoinColumn(name = "patient_id", referencedColumnName = "patId"), inverseJoinColumns = @JoinColumn(name = "doctor_id", referencedColumnName = "docId"))
