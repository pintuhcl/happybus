...
import com.example.demo.dto.UniversityCollegeDTO;
...
public class CollegeController {
	...
	public ResponseEntity<?> getUniversityCollegeById() {
		UniversityCollegeDTO ucdto= new UniversityCollegeDTO();
		List<UniversityCollegeDTO> listDto=new ArrayList<UniversityCollegeDTO>();
		 listDto = crepository.findByUniversityIdWithCollegeIdEqual();
		listDto.forEach(System.out::println);
		return ResponseEntity.ok("After inner joining the Query  ----:" + listDto);
	}
